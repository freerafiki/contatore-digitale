...
st.write(f"- {today_data['est']} a san marco, castello, cannaregio, sant'elena")
#st.write("### - dorsoduro, san polo, santa croce, giudecca")
st.write(f"- {today_data['ovest']} a dorsoduro, san polo, santa croce, giudecca")
...
st.markdown(f"- (come detto), {today_data['isole']} nella venezia insulare (centro storico)")
...
st.markdown("## Dati")
st.markdown("Il contenuto della pagina è una rielaborazione dei dati relativi a Venezia.")
st.markdown("Fonte: Opendata del comune di venezia, disponibili su dati.venezia.it")
...
st.markdown("Disponibili sotto [Licenza CC-BY](https://dati.venezia.it/?q=licenza/cc)")
